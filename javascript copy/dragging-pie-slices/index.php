...
<head>
  <meta charset="UTF-8" />
  <title>amCharts V4 Example - dragging-pie-slices</title>
...
<body>
  ...
  <script>
    ...
    var data = <?php
                  ...
                  //$fecha1 = $_POST["fecha1"];
                  //$fecha2 =  $_POST["fecha2"];
                  $consulta = "select tel_registry_incoming_calls.group, count(*) from tel_registry_incoming_calls('2018-01-01', '2019-09-25', '', '', '','' , '',0 ) where disposition= 'ANSWERED' group by tel_registry_incoming_calls.group";
                  consulta($consulta); ?>;
    ...
    series1.dataFields.category = "group";
    ...
    series2.dataFields.value = "group";
    series2.dataFields.category = "count";
